            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.code != 0) {
                        ...
                        var Data = "name=" + (userval + ("(友情票)")) + "&company=" + schoolval + "&position=" + positionval + "&mail=" + mailboxval + "&phone=" + telval + "&option01=" + checkboxval + "&ispublic=" + radiovalue + "&attendno=" + optionsval + "&type=友情票"
                        $.ajax({
                            type: "post",
                            data: Data,
                            async: true,
                            ...
                            success: function(data) {
                                ...
                                if (data.code == 0) {
                                    var ID = data.data
                                    zeng(ID, inviter_name, telval, userval, schoolval)
                                }
                            },
                        })
                    }
...
// body高度
function zeng(entryId, inviter, telval, userval, schoolval) {
