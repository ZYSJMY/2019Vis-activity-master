                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.code != 0) {
                            ...
                            var Data = "name=" + (userval + ("(回馈票)")) + "&company=" + schoolval + "&position=" + positionval + "&mail=" + mailboxval + "&phone=" + telval + "&option01=" + checkboxval + "&ispublic=" + radiovalue + "&attendno=" + optionsval + "&type=嘉宾"
                            $.ajax({
                                type: "post",
                                data: Data,
                                async: true,
