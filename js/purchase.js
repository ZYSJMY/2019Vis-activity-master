                            ...
                            WeixinJSBridge.invoke(
                                ...
                                function(res) {
                                    if (res.err_msg == "get_brand_wcpay_request:ok") {
                                        ...
                                        window.location.href = changeUrl.imgurl + "/nsi-event/2019Vis-activity/purchase.html?name=" + localStorage["name"] + "&company=" + localStorage["company"] + "&phone=" + localStorage["wechatId"] + "&id=" + localStorage["goodsId"]
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.code == 0) {
                            ...
                            window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx37e5ddff7dc5282e&redirect_uri=http://data.xinxueshuo.cn/nsi-event/2019Vis-activity/purchase.html&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect"
                        }
                    },
                    error: function() {
